...
with app.app_context():
  ...
  s3=Salon(name = "The Olaplex", location = "Manhattan, NY", 
  ...
  s6=Salon(name = "The Davines", location = "Brooklyn, NY",
  ...
  r1= Review(content = "Amazing", rating = 5, 
  ...
  r2= Review(content = "just ok", rating = 3, 
             ...
             user_id= 2, salon_id= 2)
  r3= Review(content = "crap", rating = 1, 
             image = "https://melvinduraicom.files.wordpress.com/2020/05/bad-haircut.jpg",
             user_id= 3, salon_id= 3)
  reviews = [r1, r2, r3]
